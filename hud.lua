...
local setup_hud = function(player)
	...
	hud_data.overlay = player:hud_add({
	    ...
	    text = "molten_sailor_overlay.png"
	})
...
local update_hud = function(player, has_full_suit, armor_list)
	...
	if factor_full > 0.3 then
		...
		player:hud_change(hud_data.o2_fg, "text", "molten_sailor_coolant_levels_fg_green.png")

	elseif factor_full > 0.1 then
		-- yellow
		color = get_color(255,255,0)
		player:hud_change(hud_data.o2_fg, "text", "molten_sailor_coolant_levels_fg_yellow.png")

	else
		-- red
		color = get_color(255,0,0)
		player:hud_change(hud_data.o2_fg, "text", "molten_sailor_coolant_levels_fg_red.png")
